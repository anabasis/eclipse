...
Ext.ensible.cal.EventMappings = {
    ...
    SrId:    	 {name: 'SrId'   	 , mapping: 'sr_id'  , type: 'string'},
    SrSupportId: {name: 'SrSupportId', mapping: 'sr_support_id'  , type: 'string'}
};/**
...
//    titleTextEdit: 'Edit Event',
    ...
    initComponent: function(){
        ...
        this.fbar = ['->',{
            text:this.saveButtonText, disabled:true, handler:this.onSave, scope:this
        },{
            id:this.id+'-delete-btn', text:this.deleteButtonText, disabled:true, handler:this.onDelete, scope:this, hideMode:'offsets'
        },{
    ...
    onRender : function(ct, position){
        ...
        this.notesField = new Ext.form.TextField({
            name: Ext.ensible.cal.EventMappings.Notes.name,
            fieldLabel: this.notesLabelText,
            anchor: '100%'
        });
        ...
        var items = [this.titleField, this.notesField, this.dateRangeField, this.locationField];
...
viewConfig: {
    ...
    getStoreDateParams : function(){
		...
		//jscho .... ///////
        start_date = this.viewStart.format(this.dateParamFormat);
        end_date = this.viewEnd.format(this.dateParamFormat);
		//jscho .... ///////
...
Ext.ensible.cal.CalendarPanel = Ext.extend(Ext.Panel, {
    ...
    initComponent : function(){
		...
		// jscho code ....
		if(this.showDataCalendar){
            this.tbar.items.push({
                id: this.id+'-tb-data-calendar', text: this.dataCalendarText, handler: this.onDataCalendarClick, scope: this, toggleGroup: this.id+'-tb-data-calendar'
            });
            this.viewCount++;
        }
        this.tbar.items.push('|');
     ...
     * @param {Date} startDate (optional) The new view start date (defaults to the current start date)
     */
    setDataCalendarView: function(id, startDate){
		
		if(!u_sr_all) u_sr_all = true;
		else u_sr_all = false;
		...
		App.eventStore.baseParams = {
                    tflow   : [ "com.tg.tgcs.modules.cal.TGCSCAL01" ],
                    taction : [ "getEventList"              ],
                    p_dept_code : [ u_dept_code      ],
                    p_sr_all : [ u_sr_all ],
                    start : [start_date],
                    end : 	[end_date]  
                };
    ...
    onDataCalendarClick: function(){
        this.setDataCalendarView(this.id+'-tb-data-calendar');
    },
    // jscho code...
