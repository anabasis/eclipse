 ...
 *
 */
public class LoggingSysWriter extends PrintWriter {
    /**
     ...
     */
    LoggingSysWriter(PrintStream ps, boolean autoFlush) throws LoggingException {
        super( ps, autoFlush );
    }
    ...
    public void println(char x[]) {
         ...
         super.println( Logging.format.stdPreFix("SYS")+x+Logging.format.stdPostFix() );
    }
    /**
