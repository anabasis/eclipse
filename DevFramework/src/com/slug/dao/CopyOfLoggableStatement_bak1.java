...
/**
 * A
 * <code>LoggableStatement<code> is a {@link java.sql.PreparedStatement PreparedStatement} with added logging capability.
 * <p>
...
public class CopyOfLoggableStatement_bak1 implements PreparedStatement {
	 ...
	 * 
	 * Creates {@link java.sql.PreparedStatement PreparedStatement} with the
	 * query string <code>sql</code> using the specified <code>connection</code>
	 ...
	 * forwarded to the prepared statment created from <code>connection</code>
	 ...
	 *            a "real statement"
	 * @param sql
	 *            java.lang.String thw sql to exectute
	...
	public CopyOfLoggableStatement_bak1(Connection connection, String sql)
			throws SQLException {
	...
	/**
	 * add implement methond of Preparestatement by dskim
	 */
	public void setAsciiStream(int parameterIndex, java.io.InputStream x, long l)
			throws java.sql.SQLException {

		wrappedStatement.setAsciiStream(parameterIndex, x, l);
		saveQueryParamValue(parameterIndex, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setBlob(int i, java.io.InputStream x, long l)
			throws java.sql.SQLException {
		wrappedStatement.setBlob(i, x, l);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setBlob(int i, java.io.InputStream x)
			throws java.sql.SQLException {
		wrappedStatement.setBlob(i, x);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setCharacterStream(int i, java.io.Reader x, long l)
			throws java.sql.SQLException {
		wrappedStatement.setCharacterStream(i, x, l);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setCharacterStream(int i, java.io.Reader x)
			throws java.sql.SQLException {
		wrappedStatement.setCharacterStream(i, x);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setClob(int i, java.io.Reader x, long l)
			throws java.sql.SQLException {
		wrappedStatement.setClob(i, x, l);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setClob(int i, java.io.Reader x) throws java.sql.SQLException {
		wrappedStatement.setClob(i, x);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setNCharacterStream(int i, java.io.Reader x, long l)
			throws java.sql.SQLException {
		wrappedStatement.setNCharacterStream(i, x, l);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setNCharacterStream(int i, java.io.Reader x)
			throws java.sql.SQLException {
		wrappedStatement.setNCharacterStream(i, x);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setNClob(int i, java.sql.NClob n) throws java.sql.SQLException {
		wrappedStatement.setNClob(i, n);
		saveQueryParamValue(i, n);
	}

	/**
	 * add implement methond of Preparestatement by dskim
	 */
	public void setNClob(int i, java.io.Reader x, long l)
			throws java.sql.SQLException {
		wrappedStatement.setNClob(i, x, l);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setNClob(int i, java.io.Reader x) throws java.sql.SQLException {
		wrappedStatement.setNClob(i, x);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setNString(int i, String x) throws java.sql.SQLException {
		wrappedStatement.setNString(i, x);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setRowId(int i, java.sql.RowId x) throws java.sql.SQLException {
		wrappedStatement.setRowId(i, x);
		saveQueryParamValue(i, x);
	}
	 ...
	 * add implement methond of Preparestatement by dskim
	 */
	public void setSQLXML(int i, java.sql.SQLXML x)
			throws java.sql.SQLException {
		wrappedStatement.setSQLXML(i, x);
		saveQueryParamValue(i, x);
	}

	/**
	 * Returns the sql statement string (question marks replaced with set
	 * parameter values) that will be (or has been) executed by the
	 * {@link java.sql.PreparedStatement PreparedStatement} that this
