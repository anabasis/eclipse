 ...
 *
 */
public class LoggingWarnWriter extends PrintWriter {
     ...
     */
    LoggingWarnWriter(PrintStream ps, boolean autoFlush) throws LoggingException {
        super( ps, autoFlush );
    }
   ...
   /**
    ...
    public void println(char x[]) {
         ...
         super.println( Logging.format.stdPreFix("WARN")+x+Logging.format.stdPostFix() );
    }
    /**
