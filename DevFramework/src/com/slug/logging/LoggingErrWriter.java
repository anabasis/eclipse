 ...
 *
 */
public class LoggingErrWriter extends PrintWriter {
     ...
     */
    LoggingErrWriter(PrintStream ps, boolean autoFlush) throws LoggingException {
        super( ps, autoFlush );
    }
    ...
    public void println(char x[]) {
         ...
         super.println( Logging.format.stdPreFix("ERR")+x+Logging.format.stdPostFix() );
    }
    /**
