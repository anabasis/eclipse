 ...
 *
 */
public class LoggingDevWriter extends PrintWriter {
    /**
     ...
     */
    LoggingDevWriter(PrintStream ps,boolean autoFlush) throws LoggingException {
        super( ps, autoFlush );
		this.mode = mode;
    }
    ...
    public void println(char x[]) {
         ...
         super.println( Logging.format.stdPreFix("DEV")+x+Logging.format.stdPostFix() );
    }
    /**
  ...
  /*  
    public void println(Document doc){
        ...
        try {
            ...
            //synchronized (lock) {
            //    super.print( Logging.format.stdPreFix("DEV") );
                //outputter.output(doc, System.out);
                outputter.output(doc, System.out);
            //    super.print( Logging.format.stdPostFix() );
            //    super.println();
            //}
