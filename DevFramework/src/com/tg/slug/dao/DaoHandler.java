...
public class DaoHandler extends DAOSqlHandler {
	...
	/**
	 * selectListObject �� ���� Method Vector ������ Data Set�� ��� ���� ����
	 * �޼ҵ�
	 * 
	 * @param conn
	 * @param ubox
	 ...
	 * @throws PException
	 */
	public Box selectListBox(Connection pconn, Box ubox, String input_value[])
			throws PException {
	 ...
	 * @throws PException
	 */
	public JSONObject selectListJson(Box ubox, String input_value[])
			throws PException {
	 ...
	 * @throws PException
	 */
	public JSONObject selectListJson(Connection pconn, Box ubox,
	 ...
	 * @throws PException
	 */
	public Document selectListXml(Box ubox, String input_value[])
			throws PException {
	 ...
	 * @throws PException
	 */
	public Document selectListXml(Connection pconn, Box ubox,
			String input_value[]) throws PException {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			...
			Logging.err.println(this.getClass().getName() + "."
					+ "selectListXml()" + "=>\n" + pe + "\n");
			rtnData.addContent(new Element("trxResultCode")
					.addContent(trxResultCode));
			rtnData.addContent(new Element("trxResultMsg")
					.addContent(trxResultMsg));

		} finally {
			if (pconn == null)
				try {
					close(pconn, rs, pstmt);
				} catch (Exception e) {
				}
			else
				try {
	 ...
	 * @throws PException
	 */
	public Document updateObjectDom(Box ubox, String input_value[])
			throws PException {
	 ...
	 * @throws PException
	 */
	public Document updateObjectDom(Connection pconn, Box ubox,
			String input_value[]) throws PException {
		...
		try {
			...
			Logging.err.println(this.getClass().getName() + "."
					+ "updateObjectDom()" + "=>\n" + pe + "\n");
			rtn_result[0] = "N";
			rtn_result[1] = this.getClass().getName() + "."
					+ "updateObjectDom()" + "=>\n" + pe + "\n";
		} finally {
	 ...
	 * @throws PException
	 */
	public Box updateObjectBox(Box ubox, String input_value[])
			throws PException {
	 ...
	 * @throws PException
	 */
	public Box updateObjectBox(Connection pconn, Box ubox, String input_value[])
			throws PException {
	 ...
	 * @throws PException
	 */
	public JSONObject updateObjectJson(Box ubox, String input_value[])
			throws PException {
	 ...
	 * @throws PException
	 */
	public JSONObject updateObjectJson(Connection pconn, Box ubox,
			String input_value[]) throws PException {
	...
	public String updateObjectLoggable(Box ubox, String input_value[])
			throws PException {
	 ...
	 */
	public String updateObjectLoggable(Box ubox, String input_value[],
			Connection conn) throws PException {
		PreparedStatement pstmt = null;
		...
		try {
			pstmt = new LoggableStatement(conn, query);// CLAB ó���� ����
														// LaggableStatement ���
			// pstmt = conn.prepareStatement(query);

			for (int input = 0; input < input_value.length; input++) {
				pstmt.setString(input + 1, input_value[input]);
				// Logging.dev.println("input_value[" + input + "][" +
				// input_value[input]+"]");
			}
	...
	public Box callStdProcedureObject(Box ubox, String input_value[], int outcnt) {
		...
		try {
			...
			Logging.err.println(this.getClass().getName() + "."
					+ "callStdProcedureObject()" + "=>" + se);
			trxErrMsg = this.getClass().getName() + "."
					+ "callStdProcedureObject()" + "=>" + se;
			trxResultCode = "N";
	...
	// ------------------------------------------------------------------------------
	// Method�� : callStdProcedureObject)_
	//
	// DESC : stored procedure���� data base object�� ���� ���� �޼ҵ��̴�
	// input_value[]: object�� in ���� ������ �迭
	// outcnt : out�Ǵ� ��Ҽ��� ���� �Ѵ�.
	// ���� Method :
	// ���� ������ :
	//
	//
	// ------------------------------------------------------------------------------
	public Box callStdProcedureObject(Box ubox, String input_value[],
			int outcnt, Connection conn) {
	...
	// ------------------------------------------------------------------------------
	public Box callStdProcedureObject(Box ubox, String input_value[],
			int argcnt, int outcnt, Connection conn) {
