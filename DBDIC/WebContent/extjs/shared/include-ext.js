...
(function() {
    ...
    packagePath = path + '/extjs/packages/' + theme + '/build/';
    themePath = packagePath + 'resources/' + theme + (rtl ? '-all-rtl' : '-all');
	//alert("themePath : "+ themePath);

    if (includeCSS) {
    	//alert("includeCSS : " + themePath + '-debug.css);
    	document.write('<link rel="stylesheet" type="text/css" href="' +
                            themePath + '-debug.css"/>');
    }

	//alert(" rtl : "+ path + '/extjs/ext-all' + (rtl ? '-rtl' : '') + '.js');
	document.write('<script type="text/javascript" src="' + path + '/extjs/ext-all' +
                            (rtl ? '-rtl' : '') + '.js"></script>');
    ...
    if (hasOverrides) {
        ...
        //alert("overridePath :"+ overridePath);
        ...
        if (repoDevMode &&  window.ActiveXObject) {
        	...
        	//alert('<script type="text/javascript" src="' + overridePath + '" defer></script>');
